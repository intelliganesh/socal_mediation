...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('ALTER TABLE consultation_participants ADD consultation_uuid CHAR(36) NULL');
        ...
        DB::statement('ALTER TABLE payment_requests ADD consultation_uuid CHAR(36) NULL');
        ...
        if (Schema::hasColumn('integration_logs', 'loggable_id')) {
            DB::statement('ALTER TABLE integration_logs ADD loggable_uuid CHAR(36) NULL');
        ...
        if (Schema::hasColumn('integration_logs', 'loggable_uuid')) {
            ...
            DB::statement('ALTER TABLE integration_logs ADD INDEX integration_logs_loggable_type_loggable_id_index (loggable_type, loggable_id)');
        }
    ...
    {
        if ($this->constraintExists($table, $index)) {
