...
@include('emails.partials.consultation-card', [
    ...
    'intro' => 'Hello <strong>'.e($clientName).'</strong>, your consultation with <strong>'.e($professional).'</strong> has been confirmed. Please find your consultation details below.',
